    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            setStyle: function (a, b) {
                ...
                this.setStyles(CKEDITOR.tools.cssVendorPrefix("user_files-select", "none"));
                if (CKEDITOR.env.ie) {
        ...
        function y(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.safari && m.setStyles(CKEDITOR.tools.cssVendorPrefix("user_files-select", "text"));
