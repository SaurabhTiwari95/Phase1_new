        ...
        m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase())I(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2); else {
                    ...
                    z(p, "aoDrawCallback", d.fnDrawCallback, "user_files");
                    z(p, "aoServerParams", d.fnServerParams, "user_files");
                    z(p, "aoStateSaveParams", d.fnStateSaveParams, "user_files");
                    z(p, "aoStateLoadParams",
                        d.fnStateLoadParams, "user_files");
                    z(p, "aoStateLoaded", d.fnStateLoaded, "user_files");
                    z(p, "aoRowCallback", d.fnRowCallback, "user_files");
                    z(p, "aoRowCreatedCallback", d.fnCreatedRow, "user_files");
                    z(p, "aoHeaderCallback", d.fnHeaderCallback, "user_files");
                    z(p, "aoFooterCallback", d.fnFooterCallback, "user_files");
                    z(p, "aoInitComplete", d.fnInitComplete, "user_files");
                    z(p, "aoPreDrawCallback", d.fnPreDrawCallback, "user_files");
                    i = p.oClasses;
