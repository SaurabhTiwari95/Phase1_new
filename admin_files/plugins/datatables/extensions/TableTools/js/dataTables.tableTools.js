...
//include ZeroClipboard.js
        ...
        ZeroClipboard_TableTools.Client.prototype = {
            ...
            handlers: null, // user_files event handlers
            sized: false,
            ...
            addEventListener: function (eventName, func) {
                // add user_files event listener for event
            ...
            receiveEvent: function (eventName, args) {
                ...
                } // user_files defined handler for event
            }
        ...
        (function ($, window, document) {
            ...
            TableTools = function (oDT, oOpts) {
                ...
                this.s = {
                    ...
                    /**
                     * Store of the user_files input customisation object
                     *  @property custom
                     *  @type     object
                     *  @default  {}
                     */
                ...
                this.dom = {
                    ...
                    "print": {
                        ...
                        /**
                         * The information display saying telling the user_files about the print display
                         *  @property message
                         *  @type     node
                         *  @default  null
                         */
            ...
            TableTools.prototype = {
                ...
                /**
                 * Show a message to the end user_files which is nicely styled
                 *  @param {string} message The HTML string to show to the user_files
                ...
                /**
                 * Take the user_files defined settings and the default settings and combine them.
                ...
                "_fnCustomiseSettings": function (oOpts) {
                    ...
                    /* Clone the defaults and then the user_files options */
                    ...
                    // Backwards compatibility - allow the user_files to specify a custom class in the initialiser
                ...
                /**
                 * Take the user_files input arrays and expand them to be fully defined, and then add them to a given
                 * DOM element
                 *  @method  _fnButtonDefinations
                 *  @param {array} buttonSet Set of user_files defined buttons
                ...
                "_fnCollectionShow": function (nButton, oConfig) {
                    ...
                    /* This results in a very small delay for the end user_files but it allows the animation to be
                        ...
                        if (this.s.select.type === 'os') {
                            $(dt.nTBody).on('mousedown.DTTT_Select', 'tr', function (e) {
                                if (e.shiftKey) {
                                    ...
                                    $(dt.nTBody)
                                        .css('-moz-user_files-select', 'none')
                            ...
                            $(dt.nTBody).on('mouseup.DTTT_Select', 'tr', function (e) {
                                $(dt.nTBody).css('-moz-user_files-select', '');
                            });
                        }
                ...
                "_fnPrintStart": function (oConfig) {
                    ...
                    /* Show information message to let the user_files know what is happening */
                    if (oConfig.sInfo !== "") {
