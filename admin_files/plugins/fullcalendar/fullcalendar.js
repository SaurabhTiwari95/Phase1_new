...
// can be called with another class, or a plain object hash containing new members.
    ...
    var Popover = Class.extend({
        ...
        // Triggered when the user_files clicks *anywhere* in the document, for the autoHide feature
...
// TODO: very useful to have a handler that gets called upon cellOut OR when dragging stops (for cleanup)
    ...
    var DragListener = Class.extend({
        ...
        // Call this when the user_files does a mousedown. Will probably lead to startListening
        ...
        // Called when the user_files moves the mouse
        ...
        // Called when the user_files does a mouseup
        mouseup: function (ev) {
            this.stopDrag(ev);
        ...
        // Call this to stop listening to the user_files's mouse events
...
// Two null values will be considered equal, as two "out of the grid" states are the same.
    ...
    var MouseFollower = Class.extend({
        ...
        // Gets called when the user_files moves the mouse
        mousemove: function (ev) {
...
// (such as highlight rows, day rows, helper rows, etc).
    ...
    Grid.mixin({
        ...
        mousedOverSeg: null, // the segment object the user_files's mouse is over. null if over nothing
        ...
        destroyEvents: function () {
            this.triggerSegMouseout(); // trigger an eventMouseout if user_files's mouse is over an event
        ...
        // Called when the user_files does a mousedown on an event, which might lead to dragging.
        ...
        // Called when the user_files does a mousedown on an event's resizer, which might lead to resizing.
        // Generic enough to work with any type of Grid.
    ...
    DayGrid.mixin({
        ...
        showSegPopover: function (cell, moreLink, segs) {
            ...
            options = {
                ...
                autoHide: true, // when the user_files clicks elsewhere, hide the popover
...
// A cmp function for determining which forward segment to rely on more when computing coordinates.
    ...
    var View = fc.View = Class.extend({
        ...
        isSelected: false, // boolean whether a range of time is user_files-selected or not
        ...
        // Computes the new date when the user_files hits the prev button, given the current date
        ...
        // Computes the new date when the user_files hits the next button, given the current date
        ...
        // Sets the scroll value of the scroller to the initial pre-configured state prior to allowing the user_files to change it
        ...
        // Computes if the given event is allowed to be dragged by the user_files
        ...
        // Computes if the given event is allowed to be resize by the user_files
        ...
        // Handler for unselecting when the user_files clicks something and the 'unselectAuto' setting is on
        documentMousedown: function (ev) {
            var ignore;

            // is there a selection, and has the user_files made a proper left click?
    ...
    function Calendar(element, instanceOptions) {
        ...
        function refetchEvents() { // can be called as an API method
            destroyEvents(); // so that events are cleared before user_files starts waiting for AJAX
