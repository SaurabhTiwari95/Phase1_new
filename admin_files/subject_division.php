...
<head>
    ...
    <title>Deplyser | subjects division</title>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="subject_division.php"><i class="fa fa-circle-o"></i> Subjects
                                Allotment Portal</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Subjects Division</li>
            </ol>
        </section>
            ...
            <div class="box box-default">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <form method="post" action="">
                                    <select name="brr" class="form-control select2" style="width: 100%;" required>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <center><input type="submit" class="btn btn-lg btn-bitbucket" value="Get subjects"
                                               name="nk"></center>
                            </div>
                        </div>
                    </div>
                ...
                <?php
                if (isset($_POST['nk'])) {
                    $b = $_SESSION['brr'] = $_POST['brr'];
                    $s = $_SESSION['sem'] = $_POST['sem'];
                } ?>
                </form>
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                <form method="post" action="">
                                    ...
                                    <select name="subject[]" multiple id="subject" required>
                                        <?php
                                        $e = mysqli_query($db, "select * from subject where sdname='$b' and ssem='$s'");
                                        if (mysqli_num_rows($e) > 0) {
                                            while ($v = mysqli_fetch_assoc($e)) {

                                                echo '<option value="' . $v['subname'] . '">';
                                                echo $v['subname'];
                                                echo '</option>';
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <select name="tea" class="form-control" id="teac" required>
                                    <option>Select Teacher Name</option>

                                    <?php
                                    $ev = mysqli_query($db, "select * from registration where rdesignation='teacher'");
                                    if (mysqli_num_rows($ev) > 0) {
                                        while ($vr = mysqli_fetch_assoc($ev)) {

                                            echo '<option value="' . $vr['rid'] . '">';
                                            echo $vr['rname'];
                                            echo '</option>';
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-10">
                            <div class="form-group">
                                <label>Enter sections name if not Write <b>"NA"</b></label>
                                <center><input type="text" class="form-control" placeholder="enter section name"
                                               name="sect" required></center>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    ...
                    if (isset($_POST['go'])) {
                        ...
                        @$dfb = implode(" ", $sna);
                        @$subj = $dfb;
                        $ins = mysqli_query($db, "insert into checksub (subj_name,sem,teacher_id,depp_name,sec)values('$subj','$sk','$teacher','$brk','$sec')");
                        if ($ins) {
                            ?>
                            <script>
                                ...
                                swal({
                                    ...
                                    function () {
                                        window.location.href = 'subject_division.php';
