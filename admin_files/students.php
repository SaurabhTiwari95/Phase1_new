...
<head>
    ...
    <title>Deplyser | students details</title>
                ...
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="students.php"><i class="fa fa-circle-o"></i> Students</a></li>
    ...
    <div class="content-wrapper">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Students content</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <center>
                    <div class="bg-light-blue-gradient"><h4>Upload excel sheet(.csv)</h4>
                        ...
                        <form action="teacher_xel.php" method="post" enctype="multipart/form-data">
                            <input type="file" class=" btn btn-xs " name="xl"><input type="submit" value="upload"
                                                                                     class="btn btn-sm btn-primary"
                                                                                     name="xsub"></form>
                        <div class="glyphicon glyphicon-question-sign" id="helpid" data-toggle="tooltip"
                             title="Click on 'download sample' to see the format of sheet.Excel file must be in .CSV format."></div>
                        <br><a id="sdow" style="color: whitesmoke;" class="chat" href="SAMPLE.rar"
                               DOWNLOAD="SAMPLE.rar">download sample</a>


                    </div>
                    <br>
                    <button class="btn btn-bitbucket" data-toggle="modal" data-target="#msgmodal" name="snm">set
                ...
                <div class=" modal fade" id="msgmodal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Set notification message first</h4>
                            </div>
                            <div class="modal-body">

                                <form action="" method="post">
                  <textarea class="form-control" rows="3" name="nmsg"><?php if (empty($_SESSION['nomsg'])) {
                          echo " set notification message here  first.. then you will have SEND NOTIFICATION button in ACTION column ....";
                      } else {
                          echo $_SESSION['nomsg'];
                      } ?></textarea><br>
                                ...
                                if (isset($_POST['set'])) {
                                    $nomsg = $_POST['nmsg'];
                                    $_SESSION['nomsg'] = $nomsg;
                                    ?>
                                    <script>

                                        window.alert("msg saved");
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    $er = mysqli_query($db, "select * from registration where rdesignation='student' ");
                    if (mysqli_num_rows($er) > 0) {
                        ...
                        while ($data = mysqli_fetch_assoc($er)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['rsem']; ?></td>
                                <td><?php echo $data['rsection']; ?></td>

                                <td><?php echo ucwords($data['rdepartment']); ?></td>

                                <td><?php echo $data['rgender']; ?></td>
                                <td><?php echo $data['remail']; ?></td>
                                <td><?php echo $b = $data['rmobile']; ?></td>
                                <td id="cv"><?php

                                    if ($data['ractivation'] == 'deactivated') {

                                        echo "<a id='b'  class='btn btn-sm info label-warning' href='admin_authentication_teacher.php?i=" . $data['rid'] . "'>" . ucfirst($data['ractivation']) . "</a>";
                                ...
                                <td>
                                    <?php
                                    if (!empty($_SESSION['nomsg'])) {
                                        echo "<a   class='btn btn-sm btn-linkedin' href='notification.php?j=" . $data['rid'] . "' title='Send Message'>Send Notification</a>";
                                    } else {
                                        echo "<a   class='btn btn-sm btn-linkedin disabled' href='notification.php?j=" . $data['rid'] . "'>Set Notification First</a>";
                                    }
                                    ?>
                                </td>
                            </tr>
...
<script src="../admin_files/plugins/datatables/dataTables.bootstrap.js"></script>
