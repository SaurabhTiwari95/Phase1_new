...
<head>
    ...
    <title>Deplyser | Teacher's Subjects Details</title>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Teachers Alotted Subjects List</a>
                        </li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Managing Section</a></li>
                <li class="active">Teachers Alotted Subjects</li>
            </ol>
        </section>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Teachers Subjects Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php $er = mysqli_query($db, "select * from checksub,registration where registration.rid=checksub.teacher_id ");
                    if (mysqli_num_rows($er) > 0) {
                        ...
                        while ($data = mysqli_fetch_assoc($er)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo ucwords($data['subj_name']); ?></td>

                                <td><?php echo $data['sem']; ?></td>
                                <td><?php echo $data['sec']; ?></td>
                                <td><?php echo ucwords($data['depp_name']); ?></td>
                                <td>
                                    <?php
                                    echo "<a  class='btn btn-sm info label-danger ' href='alloted_subjects.php?i=" . $data['ch_id'] . "'>" . "Delete" . "</a>";
                                    ?>
                                </td>
                            </tr>
                            <?php
